    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="flex justify-between items-center px-8 py-6 border-b">
        ...
        <ul className="flex gap-6">
          ...
          <li><a href="#work" className="hover:text-green-700">Work</a></li>
      ...
      <section id="work" className="px-8 py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-12">Latest projects</h2>
      ...
      <section id="contact" className="px-8 py-20">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
            <input type="text" placeholder="Name" className="w-full bg-gray-100 px-4 py-3 rounded" />
            <input type="email" placeholder="Email" className="w-full bg-gray-100 px-4 py-3 rounded" />
            <textarea placeholder="Type your message here" rows="5" className="w-full bg-gray-100 px-4 py-3 rounded"></textarea>
            <button type="submit" className="bg-black text-white px-8 py-3 rounded">Submit</button>
          </form>
        </div>
      </section>
